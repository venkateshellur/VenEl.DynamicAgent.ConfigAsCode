...
💻 **Source Code:** [https://github.com/venkateshellur/VenEl.Agent.ConfigAsCode](https://github.com/venkateshellur/VenEl.Agent.ConfigAsCode)
...
```bash
dotnet add package VenEl.Agent.ConfigAsCode
```
